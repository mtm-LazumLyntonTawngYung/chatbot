...
def info_from_ApiKeyAuth(api_key, required_scopes):
    ...
    Returned value will be passed in 'token_info' parameter \
        of your operation function, if there is one.
    'sub' or 'uid' will be set in 'user' parameter of your \
    ...
    :return: Information attached to provided api_key \
        or None if api_key is \
